...
def Loop():
    ...
    for HistoName in ["pTH","pTWplus","nJets","mH","mWplus","nBTags", "maxMVAResponse"]:
    ...
    #for HistoName in ["DeltaPhi_HW"]:
        ...
        file1=TFile.Open("/cephfs/user/s6subans/ChargedHiggs_Mock/output_SR_NewBDT_imp2sig/sig_Hplus_Wh_m800-0_70p.root","READ")
        dir1=file1.GetDirectory("Nominal").GetDirectory(HistoName+"_2sig")
        ...
        file6=TFile.Open("/cephfs/user/s6subans/ChargedHiggs_Mock/output_SR_NewBDT_imp2sig/sig_Hplus_Wh_m400-0_70p.root","READ")
        dir6=file6.GetDirectory("Nominal").GetDirectory(HistoName+"_2sig")
        ...
        dir7=file7.GetDirectory("Nominal").GetDirectory(HistoName+"_2sig")
        ...
        file5=TFile.Open("/cephfs/user/s6subans/ChargedHiggs_Mock/output_SR_NewBDT_imp2sig/ttbar_70p.root","READ")
        dir5=file5.GetDirectory("Nominal").GetDirectory(HistoName+"_2sig")
        ...
        file2=TFile.Open("/cephfs/user/s6subans/ChargedHiggs_Mock/output_SR_NewBDT_imp2sig/Wjets_70p.root","READ")
        dir2=file2.GetDirectory("Nominal").GetDirectory(HistoName+"_2sig")
        ...
        file3=TFile.Open("/cephfs/user/s6subans/ChargedHiggs_Mock/output_SR_NewBDT_imp2sig/singleTop_70p.root","READ")
        dir3=file3.GetDirectory("Nominal").GetDirectory(HistoName+"_2sig")
        ...
        dir4=file4.GetDirectory("Nominal").GetDirectory(HistoName+"_2sig")
        ...
        dir8=file8.GetDirectory("Nominal").GetDirectory(HistoName+"_2sig")
        #dir8=file8.GetDirectory("Nominal").GetDirectory(HistoName)
        h_backgHisto_Z=dir8.Get("Zjets_"+HistoName+"_"+Region+"_"+btagStrategy+"_Nominal")
            
        h_backgHisto=h_backgHisto_t+h_backgHisto_W+h_backgHisto_single+h_backgHisto_diboson+h_backgHisto_Z
        #h_backgHisto=h_backgHisto_W+h_backgHisto_single+h_backgHisto_diboson
       ...
       # graph_800_z.Draw("P")
        ...
        print x 
           ...
           # graphZ.Draw("ACP")
        c1.Update()
        c1.SaveAs("../Plots/Sig_Plots/m400/m400_%s_newBDT_inclusive_imp2sig.pdf"% (HistoName))
        pad1.Close()
        pad2.Close()
        c1.Close()
