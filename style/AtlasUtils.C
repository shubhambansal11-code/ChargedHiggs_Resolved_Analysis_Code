...
void ATLAS_LABEL(Double_t x,Double_t y, TString status ,Color_t color, Double_t xoffset, Double_t size) 
{
  TLatex l, m; //l.SetTextAlign(12); l.SetTextSize(tsize);
  l.SetNDC();
  l.SetTextFont(72);
  ...
  m.SetTextSize(size);
  m.DrawLatex(x+xoffset,y,status);
}
